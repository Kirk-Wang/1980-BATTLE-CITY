...
export default class Bot {
    public readonly noteChannel = multicastChannel<Note>();
    private _fire = false;
    ...
    public *forward(forwardLength: number) {
    ...
    public readonly directionControllerCallback = (tank: TankRecord): Input => {
    ...
    public readonly fireControllerCallback = () => {
        if (this._fire) {
            this._fire = false;
            return true;
        } else {
