...
export class RelativePosition {
    public readonly subject: Point;
    public readonly object: Point;
    public readonly dx: number;
    public readonly dy: number;
    public readonly absdx: number;
    public readonly absdy: number;
    ...
    public getPrimaryDirection(): Direction {
    ...
    public getForwardInfo(direction: Direction) {
        if (direction === "left") {
            return {
                length: -this.dx,
                offset: this.absdy,
