...
if (DEV.INSPECTOR) {
    ...
    class Inspector extends React.PureComponent<State, S> {
        ...
        public componentWillReceiveProps(nextProps: State) {
            ...
            return (
                ...
                >
                    <div style={{ display: "flex", alignItems: "center" }}>
                        view:
                        <select value={this.state.view} onChange={e => this.setState({ view: e.target.value as View })}>
