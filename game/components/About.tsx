...
const AboutEditor = () => (
    <div>
        ...
        <p>
            在 map tab 中配置关卡地图，选定一种画笔之后，在地图中按下鼠标并拖拽，来完成地图配置。brick-wall 和
...
const AboutTitle = () => (
    <div>
        <p>
            目前只支持单人进行游戏。请使用最新的 chrome 浏览器，并适当调整浏览器的缩放比例（1080P 下设置为 200%
            缩放），以获得最好的游戏体验。
        </p>
        ...
        return (
            <div className={classNames("about", { hide })}>
                ...
                {/* <Switch>
                    ...
                    <Route exact={true} path="/gameover" render={AboutGame} />
