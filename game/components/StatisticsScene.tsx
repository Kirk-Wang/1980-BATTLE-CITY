    ...
    public renderPlayer2KillInfo() {
        ...
        return (
            <g>
                ...
                <Text content={`\u2192 ${basicCountStr} PTS ${basicPointsStr}`} x={9 * B} y={8 * B} fill="white" />
                <Text content={`\u2192 ${fastCountStr} PTS ${fastPointsStr}`} x={9 * B} y={9.5 * B} fill="white" />
                <Text content={`\u2192 ${powerCountStr} PTS ${powerPointsStr}`} x={9 * B} y={11 * B} fill="white" />
                <Text content={`\u2192 ${armorCountStr} PTS ${armorPointsStr}`} x={9 * B} y={12.5 * B} fill="white" />
