...
type TankComponent = (props: { transform?: string; color: string; shape: number }) => JSX.Element;
...
namespace TankColorConfig {
    ...
    export const withPowerUp = new Timing<TankColor>([{ v: "red", t: f(8) }, { v: "silver", t: f(8) }]);
    ...
    public render() {
        ...
        return (
            <g style={{ visibility: tank.visible ? null : "hidden" }}>
                {img}
                {DEV.RESTRICTED_AREA && showReservedIndicator && (
