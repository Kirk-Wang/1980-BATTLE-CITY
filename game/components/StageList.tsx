...
const EDIT_BUTTON_PIXELS: Array<[number, number]> = [
    [5, 0],
    [4, 1],
    [5, 1],
    [6, 1],
...
class StageListPageUnconnected extends React.PureComponent<StageListProps> {
    ...
    public async onDelete(stageName: string) {
        const {
    ...
    public async onDownload(stageName: string) {
    ...
    public render() {
        ...
        return (
            <Screen background="#333">
                ...
                />
                {stages.isEmpty() ? <Text x={0.5 * B} y={3 * B} content="No custom stage." fill="#666666" /> : null}
    ...
    public render() {
        ...
        return (
            <PopupProvider>
                {popupHandle => (
                    <Switch>
                        <Route exact={true} path="/list" render={() => <Redirect to="/list/default" />} />
                        <Route exact={true} path="/list/default" render={() => <Redirect to="/list/default/1" />} />
                        <Route exact={true} path="/list/custom" render={() => <Redirect to="/list/custom/1" />} />
                        <Route
