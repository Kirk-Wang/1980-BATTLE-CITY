...
namespace GalleryContent {
            ...
            return (
                <g>
                    ...
                    <Transform y={176}>
                        ...
                        <Transform x={64}>
                            <X2Tank x={48 * 0} y={0} side="bot" level="basic" withPowerUp={true} />
                            <X2Tank x={48 * 1} y={0} side="bot" level="fast" withPowerUp={true} />
                            <X2Tank x={48 * 2} y={0} side="bot" level="power" withPowerUp={true} />
                            <X2Tank x={48 * 3} y={0} side="bot" level="armor" withPowerUp={true} />
                        </Transform>
                    </Transform>
                </g>
            );
        ...
        public render() {
            ...
            return (
                <g>
                    ...
                    <Transform x={16} y={40}>
                        {game.paused ? <PauseIndicator content="paused" noflash={true} /> : null}
                        {game.paused ? <PauseIndicator content="paused" noflash={true} y={6 * B} /> : null}
                    </Transform>
    ...
    const player1KillInfo = Map<TankLevel, number>([["basic", 10], ["fast", 4], ["power", 0], ["armor", 1]]);
    const player2KillInfo = Map<TankLevel, number>([["basic", 4], ["fast", 0], ["power", 2], ["armor", 1]]);
        ...
        return (
            <Screen background="#333">
                ...
                <g transform={`translate(${8 * B}, 8)`}>
                    <TextButton x={0 * B} content="prev" onClick={this.onChoosePrevTab} disabled={index === 0} />
                    <TextButton
                        x={2.5 * B}
                        content="next"
